...
class TestBankingSystem(unittest.TestCase):
    ...
    def setUp(self):
        """
        Set up a new BankingSystem and BankAccount instance before each test.
        """
    ...
    def test_auth_user_already_logged_in(self):
        """
        Test authentication when the user is already logged in.
        """
    ...
    def test_transfer_money_sender_not_authenticated(self):
        """
        Test transfer money when the sender is not authenticated.
        """
        # self.bank.authenticate('user123', 'pass123')
        self.assertEqual(
    ...
    def test_transfer_money_sender_wrong_transaction_type(self):
        """
        Test transfer money when the sender provides a wrong transaction type.
        """
        self.bank.authenticate("user123", "pass123")
    ...
    def test_transfer_money_sender_type_regular(self):
        """
        Test transfer money when the sender provides a valid transaction type 'regular'.
        """
        self.bank.authenticate("user123", "pass123")
        self.assertEqual(
    ...
    def test_transfer_money_sender_type_express(self):
        """
        Test transfer money when the sender provides a valid transaction type 'express'.
        """
        self.bank.authenticate("user123", "pass123")
        # Monto ajustado para cubrir el fee 5%
        self.assertTrue(self.bank.transfer_money("user123", "user2", 900, "express"))

    def test_transfer_money_sender_type_scheduled(self):
        """
        Test transfer money when the sender provides a valid transaction type 'scheduled'.
        """
        self.bank.authenticate("user123", "pass123")
        # Monto ajustado para cubrir el fee 1%
    ...
    def test_transfer_money_insufficient_funds_regular(self):
        """
        Test transfer money when the sender has insufficient funds for 'regular' transfer.
        """
        self.bank.authenticate("user123", "pass123")
        # Monto demasiado alto para el balance de 1000 en BankAccount simulado
    ...
    def test_transfer_money_insufficient_funds_express(self):
        """
        Test transfer money when the sender has insufficient funds for 'express' transfer.
        """
        self.bank.authenticate("user123", "pass123")
        self.assertFalse(
    ...
    def test_transfer_money_insufficient_funds_scheduled(self):
        """
        Test transfer money when the sender has insufficient funds for 'scheduled' transfer.
        """
        self.bank.authenticate("user123", "pass123")
        self.assertFalse(
    ...
    def test_bank_account_view_account(self):
        """
        Test the view_account method of BankAccount.
        """
        ...
        self.assertEqual(
            output.getvalue(),
            f"The account {self.bank_account.account_number} has a balance of "
